    ...
    >
      <nav className=" container m-auto flex items-center justify-between">
        <div data-aos="fade-down" className="logo">
          <img width={150} src="https://i.imghippo.com/files/PVnFS1712454995.png" alt="logo" />
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          ...
          <div data-aos="fade-up" className="buttons flex gap-5">
            ...
            <a
              ...
              className="flex items-center gap-2 border- text-[1.2rem] bg-white border-black px-7 py-6 sm:px-6 rounded-lg font-bold  hover:text-yellow-500"
            >
